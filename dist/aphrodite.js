...
/***/ function(module, exports, __webpack_require__) {
	...
	var _criticalStyles = __webpack_require__(32);
	...
	*/
	...
	selectorHandlers /* : SelectorHandler[] */
	    ...
	    var css = function css() {
	        ...
	        return (/* : MaybeSheetDefinition[] */(0, _inject.injectAndGetClassName)(useImportant, styleDefinitions, selectorHandlers)
	        );
	    };
	    return {
	        ...
	        criticalStyles: function criticalStyles() /* : Array<criticals> */{
	            for (var _len2 = arguments.length, criticals = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
	                criticals[_key2] = arguments[_key2];
	            }

	            return _criticalStyles.criticalStylesCreator.apply(undefined, [css].concat(criticals));
	        }
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var criticalStylesCreator = function criticalStylesCreator(css /* : function */) /* : Array<criticals> */{
	    ...
	    styles.forEach(function (s) {
	        if (typeof s === 'function') {
	            ...
	            calcs[calcs.length] = function (props) {
	                return css.apply(undefined, _toConsumableArray([].concat(s(props))));
	            };
	        } else {
	            // its a style or an array of styles
	            css.apply(undefined, _toConsumableArray([].concat(s)));
	        }
	    });

	    if (calcs.length) return function (WrappedComponent /*: ReactClass<*> */) {
	        return critical(calcs, WrappedComponent);
	    };

	    return clean;
	};

	exports.criticalStylesCreator = criticalStylesCreator;
	// eslint-disable-next-line one-var
	var clean = function clean(WrappedComponent /* : ReactClass<*> */) {
	    return WrappedComponent;
	};

	// eslint-disable-next-line one-var
	var critical = function critical(calcs, WrappedComponent /* : ReactClass<*> */) {
	        ...
	        */
	        ...
	        _createClass(_class, [{
	            ...
	            value: function componentWillMount() {
	                ...
	                calcs.forEach(function (sty) {
	                    return sty(_extends({}, WrappedComponent.defaultProps, _this.props));
	                });
